...
ATTENDANCE_SHEETS = {
    ...
    'Сентябрь': {'id': '15oJ8Mvl-DJtrqGPXjOC550dmrE6PsPy8Bi8NjGTTTuI', 'gid': '411480352'},
}
...
def fetch_monthly_paying():
    ...
    try:
        ...
        # Строим месяцы 2026: от первого месяца с данными до декабря
        first_month = min((m for (y, m) in snapshot if y == 2026), default=datetime.now().month)
        result = []
...
def index():
    ...
    return render_template('index.html',
        ...
        instagram=instagram, ig_monthly=ig_monthly, ig_max=ig_max, ig_min=ig_min,
